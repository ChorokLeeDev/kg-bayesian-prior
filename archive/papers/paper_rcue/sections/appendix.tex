...
YAGO3-10 & $0.46$ & $0.92$ & +46pp \\
ICEWS14 & $0.89$ & $0.999$ & +11pp \\
\bottomrule
\end{tabular}
\end{table}

$^*$YAGO3-10 shows Energy AUROC of 0.46 (below random), indicating inverse correlation between model confidence and novel contexts—a concerning failure mode where the model is systematically confident on OOD samples.
