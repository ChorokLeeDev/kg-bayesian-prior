...
\begin{table}[h]
\centering
\caption{OOD detection AUROC for novel context triples. Higher is better. RCUE substantially outperforms all baselines across all datasets.}
\label{tab:main}
\begin{tabular}{lcccc}
\toprule
Method & FB15k-237 & WN18RR & YAGO3-10 & ICEWS14 \\
\midrule
Energy & 0.64 & 0.79 & 0.52 & 0.88 \\
UKGE & 0.50 & 0.50 & 0.50 & 0.50 \\
Deep Ensemble & 0.47 & -- & -- & -- \\
MC Dropout & 0.53 & -- & -- & -- \\
BEUrRE & 0.58 & 0.62 & -- & -- \\
\midrule
\textbf{RCUE} & \textbf{0.97} & \textbf{0.97} & \textbf{0.95} & \textbf{0.998} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item Improvement ranges from +11pp (ICEWS14) to +43pp (YAGO3-10)
\end{itemize}
...
Coverage tracking provides +31pp improvement, confirming that learned components alone cannot detect novel contexts.
