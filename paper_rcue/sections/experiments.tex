...
\begin{table}[h]
\centering
\caption{OOD detection AUROC for novel context triples (mean $\pm$ std over 3 seeds). Higher is better. RCUE substantially outperforms all baselines across all datasets.}
\label{tab:main}
\begin{tabular}{lcccc}
\toprule
Method & FB15k-237 & WN18RR & YAGO3-10 & ICEWS14 \\
\midrule
Energy & 0.62{\tiny $\pm$.01} & 0.79 & 0.52 & 0.88 \\
UKGE & 0.50{\tiny $\pm$.00} & 0.50 & 0.50 & 0.50 \\
Deep Ensemble & 0.47 & -- & -- & -- \\
MC Dropout & 0.53 & -- & -- & -- \\
BEUrRE & 0.48{\tiny $\pm$.01} & 0.41 & -- & -- \\
\midrule
\textbf{RCUE} & \textbf{0.96}{\tiny $\pm$.02} & \textbf{0.89} & \textbf{0.95} & \textbf{0.998} \\
\bottomrule
\end{tabular}
\end{table}
